    ...
    <table class="table-auto min-w-full divide-y divide-gray-300 mt-6">
        ...
        <tr>
            ...
            <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                <a href="/transaction/<?php echo e($transaction['ID']); ?>/receipt" class="p-2 bg-amber-50 text-xs text-amber-900 hover:bg-amber-500
                hover:text-white transition rounded">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24"
                         stroke-width="1.5" stroke="currentColor" class="w-4 h-4">
                        <path stroke-linecap="round" stroke-linejoin="round" d="M9 8.25H7.5a2.25 2.25 0 00-2.25
                        2.25v9a2.25 2.25 0 002.25 2.25h9a2.25 2.25 0 002.25-2.25v-9a2.25 2.25 0 00-2.25-2.25H15M9 12l3
                        3m0 0l3-3m-3 3V2.25" />
                    </svg>
                </a>
                <a href="/transaction/<?php echo e($transaction['ID']); ?>" class="p-2 bg-emerald-50 text-xs
