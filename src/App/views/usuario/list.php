<?php include $this->resolve("partials/_header.php"); ?>
    ...
    <section class="container mx-auto mt-12 p-4 bg-white shadow-md border border-gray-200 rounded">
        <div class="flex items-center justify-between border-b border-gray-200 pb-4">
            <h4 class="font-medium">Lista de Usuarios</h4>
            <div class="flex space-x-4">
                <a href="/cadastrar" class="flex items-center p-2 bg-sky-50 text-xs text-sky-900 hover:bg-sky-500 hover:text-white transition rounded">
        ...
        <form method="get" class="mt-4 w-full">
            <div class="flex">
                <input value="<?php echo e((string) $mSearchTerm); ?>" name="s" type="text" class="w-full rounded-l-md border-0 px-3.5 py-2 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6" placeholder="Pesquisar Usuario" />
        ...
        <table class="table-auto min-w-full divide-y divide-gray-300 mt-6">
            ...
            <?php foreach ($aUsuarios as $aUsuario) : ?>
                <tr>
                    <!-- ID -->
                    <td class="p-4 text-sm text-gray-600"><?php echo e($aUsuario['id'])?></td>
                    <!-- Nome -->
                    <td class="p-4 text-sm text-gray-600"><?php echo e($aUsuario['username'])?></td>
                    <!-- Tipo -->
                    <td class="p-4 text-sm text-gray-600"><?php echo e($aUsuario['isAdmin'])?></td>
                    <!-- Ultima Atualizacao -->
                    <td class="p-4 text-sm text-gray-600"><?php echo e($aUsuario['lastUpdate'])?></td>
                    <!-- Acoes -->
                    <td class="p-4 text-sm text-gray-600 flex justify-center space-x-2">
                        <a href="/usuario/<?php echo e($aUsuario['id']); ?>" class="p-2 bg-emerald-50 text-xs
                text-emerald-900 hover:bg-emerald-500 hover:text-white transition rounded">
                        ...
                        <form action="/usuario/<?php echo e($aUsuario['id']); ?>" method="post">
        ...
        <nav class="flex items-center justify-between border-t border-gray-200 px-4 sm:px-0 mt-6">
            ...
            <div class="-mt-px flex w-0 flex-1">
                <?php if ($iCurrentPage > 1) : ?>
                    <a href="/usuario?<?php echo e($aPreviousPageQuery); ?>" class="inline-flex items-center border-t-2 border-transparent pr-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
            ...
            <div class="hidden md:-mt-px md:flex">
                <?php foreach ($aPageLinks as $iPageNum => $sQuery) : ?>
                    <a
                        href="/usuario?<?php echo e($sQuery); ?>"
            ...
            <div class="-mt-px flex w-0 flex-1 justify-end">
                <?php if ($iCurrentPage < $iLastPage) : ?>
                    <a href="/usuario?<?php echo $aNextPageQuery; ?>" class="inline-flex items-center border-t-2 border-transparent pl-1 pt-4 text-sm font-medium text-gray-500 hover:border-gray-300 hover:text-gray-700">
                        Proxima
